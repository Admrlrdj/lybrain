...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8" />
    <title class="blog-title">Lybrain - <?= isset($tabTitle) ? $tabTitle : 'New Page Title'; ?></title>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/ijaboCropTool/ijaboCropTool.min.css" />
